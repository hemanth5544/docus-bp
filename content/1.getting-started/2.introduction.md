---
title: Introduction
description: Welcome to Boiler Plate documentation.
navigation:
  icon: i-lucide-house
seo:
  title: Introduction
...
Welcome to **Boiler Plate**, a fully integrated boiler plate solution built for backend written in  [Node](https://ui.nuxt.com).
